...
from unshortenme_sdk.utility import register

# Load features
from unshortenme_sdk.feature.base_feature import UnshortenmeBaseFeature
from unshortenme_sdk.features import _has_feature, _make_feature
...
class UnshortenmeSDK:
    ...
    def __init__(self, options=None):
        ...
        utility = UnshortenmeUtility()
        self._utility = utility

        from unshortenme_sdk.config import shared_config
    ...
    def get_utility(self):
        return UnshortenmeUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("UnshortenmeSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def Unshorten(self, data=None) -> "UnshortenEntity":
        ...
        from unshortenme_sdk.entity.unshorten_entity import UnshortenEntity
