# Unshortenme SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions UnshortenmeSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both UnshortenmeSDK(...) and UnshortenmeSDK.test(...) become
#      UnshortenmeSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "unshortenme_sdk"
_SDK_CLASS = "UnshortenmeSDK"
