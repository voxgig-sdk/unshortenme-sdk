...
import (
	...
	vs "github.com/voxgig-sdk/unshortenme-sdk/go/utility/struct"
)

type UnshortenEntity struct {
	name    string
	client  *core.UnshortenmeSDK
...
func NewUnshortenEntity(client *core.UnshortenmeSDK, entopts map[string]any) *UnshortenEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *UnshortenEntity) GetName() string { return e.name }
...
func (e *UnshortenEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *UnshortenEntity) Deleted() bool {
	return e.deleted
}


func (e *UnshortenEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewUnshortenEntity(e.client, opts)
}

func (e *UnshortenEntity) Data(args ...any) any {
...
func (e *UnshortenEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Unshorten; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *UnshortenEntity) DataTyped(data ...Unshorten) Unshorten {
	if len(data) > 0 {
		return typedFrom[Unshorten](e.Data(asMap(data[0])))
	}
	return typedFrom[Unshorten](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Unshorten (all fields
// optional at the wire level).
func (e *UnshortenEntity) MatchTyped(match ...Unshorten) Unshorten {
	if len(match) > 0 {
		return typedFrom[Unshorten](e.Match(asMap(match[0])))
	}
	return typedFrom[Unshorten](e.Match())
}
...
func (e *UnshortenEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *UnshortenEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// UnshortenLoadMatch and returns an Unshorten. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *UnshortenEntity) LoadTyped(reqmatch UnshortenLoadMatch, ctrl map[string]any) (Unshorten, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return Unshorten{}, err
	}
	return typedFrom[Unshorten](res), nil
}



func (e *UnshortenEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *UnshortenEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *UnshortenEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *UnshortenEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *UnshortenEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
