...
func (sdk *UnshortenmeSDK) OptionsMap() map[string]any {
...
func (sdk *UnshortenmeSDK) GetUtility() *Utility {
	return CopyUtility(sdk.utility)
}

func (sdk *UnshortenmeSDK) GetRootCtx() *Context {
	return sdk.rootctx
}

func (sdk *UnshortenmeSDK) Prepare(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *UnshortenmeSDK) Direct(fetchargs map[string]any) (map[string]any, error) {
...
func (sdk *UnshortenmeSDK) opAllowed(op string) bool {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return strings.Contains(allowOp, op)
}

func (sdk *UnshortenmeSDK) opDenied(op string) map[string]any {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return map[string]any{
		"ok": false,
		"err": fmt.Errorf("UnshortenmeSDK: %s: operation not allowed by"+
...
// gate by passing it.
func (sdk *UnshortenmeSDK) rawRequest(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *UnshortenmeSDK) Graphql(
	...
	if 0 < len(errors) {
		...
		res["ok"] = false
		res["err"] = fmt.Errorf("UnshortenmeSDK: graphql: %s", msg)
		res["graphql"] = errors
	}
