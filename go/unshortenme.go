...
// instead of `sdk.NewUnshortenmeSDK(nil)` / `sdk.TestSDK(nil, nil)`
// for the common no-options case.
func New() *UnshortenmeSDK  { return NewUnshortenmeSDK(nil) }
func Test() *UnshortenmeSDK { return TestSDK(nil, nil) }
