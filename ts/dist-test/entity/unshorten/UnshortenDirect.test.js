...
(0, node_test_1.describe)('UnshortenDirect', async () => {
    ...
    (0, node_test_1.test)('direct-exists', async () => {
        const sdk = new __1.UnshortenmeSDK({
    ...
    (0, node_test_1.test)('direct-load-unshorten', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-unshorten', setup.live))
            return;
...
function liveScenariosActive() { return false && process.env.UNSHORTENME_TEST_LIVE === 'TRUE'; }
function directSetup(mockres) {
    ...
    if (live) {
        ...
        const client = new __1.UnshortenmeSDK(Object.assign({}, (0, utility_1.liveClientOptions)(), { system: { fetch: transport.fetch },
            apikey: env.UNSHORTENME_APIKEY,
        }));
        let idmap = env['UNSHORTENME_TEST_UNSHORTEN_ENTID'];
    ...
    const client = new __1.UnshortenmeSDK({
        base: 'http://localhost:8080',
...
//# sourceMappingURL=UnshortenDirect.test.js.map