...
function envOverride(m) {
    if ('TRUE' === process.env.UNSHORTENME_TEST_LIVE ||
        'TRUE' === process.env.UNSHORTENME_TEST_OVERRIDE) {
    ...
    m.UNSHORTENME_TEST_EXPLAIN = process.env.UNSHORTENME_TEST_EXPLAIN || m.UNSHORTENME_TEST_EXPLAIN;
    return m;
}
