# Unshortenme TypeScript SDK



The TypeScript SDK for the Unshortenme API — a type-safe, entity-oriented client with full async/await support.

The API is exposed as capitalised, semantic **Entities** — e.g.
`client.Unshorten()` — each with a small set of operations (`load`)
...
```ts
const client = new UnshortenmeSDK({ apikey: '...' })
...
| Method | Returns | Description |
| --- | --- | --- |
| `UnshortenmeSDK.test(testopts?, sdkopts?)` | `UnshortenmeSDK` | Create a test-mode client. |
...
unshortenme/
├── src/
│   ├── UnshortenmeSDK.ts        # Main SDK class
