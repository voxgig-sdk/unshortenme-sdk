...
{
    private static function utility(): UnshortenmeUtility
    {
        return new UnshortenmeUtility();
    }
    ...
    private static function ctx(array $over = []): UnshortenmeContext
    {
        $utility = $over['utility'] ?? self::utility();
        $client = $over['client'] ?? new PlClient(['base' => 'http://h']);
        $ctx = new UnshortenmeContext([
            'client' => $client,
            'utility' => $utility,
        ], null);
        $ctx->op = new UnshortenmeOperation(['name' => 'load', 'entity' => 'x']);
        foreach ($over as $k => $v) {
    ...
    {
        return ($err instanceof UnshortenmeError) ? $err->sdk_code : '';
    }
    ...
    public function test_make_point_rejects_a_disallowed_operation(): void
    {
        ...
        $ctx->op = new UnshortenmeOperation(['name' => 'nope', 'entity' => 'x']);
        [$point, $err] = UnshortenmeMakePoint::call($ctx);
    ...
    public function test_make_point_rejects_an_operation_with_no_endpoints(): void
    {
        ...
        $ctx->op = new UnshortenmeOperation(['name' => 'load', 'entity' => 'x', 'points' => []]);
        [$point, $err] = UnshortenmeMakePoint::call($ctx);
        $this->assertNull($point);
    ...
    public function test_make_point_returns_the_single_point(): void
    {
        ...
        $ctx = self::ctx(['options' => ['allow' => ['op' => 'load,list,create,update,remove']]]);
        $ctx->op = new UnshortenmeOperation(['name' => 'load', 'entity' => 'x', 'points' => [$point]]);
        [$got, $err] = UnshortenmeMakePoint::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new UnshortenmeSpec(['method' => 'GET']);
        $ctx = self::ctx();
        $ctx->out['spec'] = $preset;
        [$got, $err] = UnshortenmeMakeSpec::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_response_guards_missing_spec_response_result(): void
    {
        $ctx = self::ctx([
            'spec' => null,
            'response' => new UnshortenmeResponse([]),
            'result' => new UnshortenmeResult([]),
        ]);
        [, $err] = UnshortenmeMakeResponse::call($ctx);
        $this->assertSame('response_no_spec', self::code($err));

        $ctx = self::ctx([
            'spec' => new UnshortenmeSpec([]),
            'response' => null,
            'result' => new UnshortenmeResult([]),
        ]);
        [, $err] = UnshortenmeMakeResponse::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'spec' => new UnshortenmeSpec(['step' => 's']),
            'response' => new UnshortenmeResponse(self::resp(404, null, ['x-a' => '1'])),
            'result' => new UnshortenmeResult([]),
        ]);
        [, $err] = UnshortenmeMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_2xx_parses_the_body_and_marks_ok(): void
    {
        $ctx = self::ctx([
            'spec' => new UnshortenmeSpec(['step' => 's']),
            'response' => new UnshortenmeResponse(self::resp(200, ['v' => 1])),
            'result' => new UnshortenmeResult([]),
        ]);
        [, $err] = UnshortenmeMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_records_to_ctrl_explain_when_explain_is_on(): void
    {
        $ctx = self::ctx([
            'spec' => new UnshortenmeSpec(['step' => 's']),
            'response' => new UnshortenmeResponse(self::resp(200, ['v' => 2])),
            'result' => new UnshortenmeResult([]),
        ]);
        $ctx->ctrl->explain = ['on' => true];
        UnshortenmeMakeResponse::call($ctx);
    ...
    {
        $preset = new UnshortenmeResponse(self::resp(299));
        $ctx = self::ctx([
            'spec' => new UnshortenmeSpec([]),
            'response' => new UnshortenmeResponse([]),
            'result' => new UnshortenmeResult([]),
        ...
        [$got, $err] = UnshortenmeMakeResponse::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null, 'result' => new UnshortenmeResult([])]);
        [, $err] = UnshortenmeMakeResult::call($ctx);
        $this->assertSame('result_no_spec', self::code($err));

        $ctx = self::ctx(['spec' => new UnshortenmeSpec([]), 'result' => null]);
        [, $err] = UnshortenmeMakeResult::call($ctx);
    ...
    public function test_make_result_list_op_wraps_resdata_into_entity_instances(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new UnshortenmeSpec(['step' => 's']),
            'result' => new UnshortenmeResult(['ok' => true, 'resdata' => [['a' => 1], ['a' => 2]]]),
        ]);
        $ctx->op = new UnshortenmeOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = UnshortenmeMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_result_empty_list_yields_empty_resdata(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new UnshortenmeSpec(['step' => 's']),
            'result' => new UnshortenmeResult(['ok' => true, 'resdata' => []]),
        ]);
        $ctx->op = new UnshortenmeOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = UnshortenmeMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new UnshortenmeResult(['ok' => true]);
        $ctx = self::ctx([
            'spec' => new UnshortenmeSpec([]),
            'result' => new UnshortenmeResult([]),
        ]);
        $ctx->out['result'] = $preset;
        [$got, $err] = UnshortenmeMakeResult::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_request_guards_a_missing_spec(): void
    {
        ...
        [, $err] = UnshortenmeMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $boom = new UnshortenmeError('boom', 'boom');
        $utility->fetcher = function (UnshortenmeContext $_c, string $_u, array $_f) use ($boom): array {
            return [null, $boom];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new UnshortenmeSpec(['step' => 's', 'method' => 'GET', 'base' => 'http://h', 'parts' => ['a']]),
        ]);
        [$response, $err] = UnshortenmeMakeRequest::call($ctx);
        $this->assertNull($err);
    ...
    {
        $utility = self::utility();
        $utility->fetcher = function (UnshortenmeContext $_c, string $_u, array $_f): array {
            return [null, null];
        };
        $ctx = self::ctx([
            'utility' => $utility,
    ...
    public function test_make_request_a_normal_transport_response_is_wrapped(): void
    {
        ...
        [$response, $err] = UnshortenmeMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertInstanceOf(UnshortenmeResponse::class, $response);
    ...
    public function test_make_request_records_the_fetchdef_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->explain = ['on' => true];
        UnshortenmeMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $utility->make_fetch_def = function (UnshortenmeContext $c): array {
            return [null, $c->make_error('fetchdef_boom', 'boom')];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new UnshortenmeSpec(['step' => 's', 'method' => 'GET']),
        ]);
        [$response, $err] = UnshortenmeMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertNotNull($response->err);
    ...
    {
        $preset = new UnshortenmeResponse(self::resp(201));
        $ctx = self::ctx(['spec' => new UnshortenmeSpec([])]);
        $ctx->out['request'] = $preset;
        [$got, $err] = UnshortenmeMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null]);
        [, $err] = UnshortenmeMakeFetchDef::call($ctx);
    ...
    public function test_make_fetch_def_serialises_body_and_inits_missing_result(): void
    {
        ...
        [$fetchdef, $err] = UnshortenmeMakeFetchDef::call($ctx);
        $this->assertNull($err);
    ...
    {
        $ctx = self::ctx(['result' => new UnshortenmeResult(['ok' => true, 'resdata' => 42])]);
        $this->assertSame(42, UnshortenmeDone::call($ctx));
    }

    public function test_done_raises_the_error_when_not_ok(): void
    {
        $ctx = self::ctx(['result' => new UnshortenmeResult(['ok' => false])]);
        $this->expectException(UnshortenmeError::class);
        UnshortenmeDone::call($ctx);
    }

    public function test_make_error_returns_resdata_when_ctrl_throw_is_false(): void
    {
        $ctx = self::ctx(['result' => new UnshortenmeResult(['ok' => false, 'resdata' => 'fallback'])]);
        $ctx->ctrl->throw_err = false;
        $this->assertSame('fallback', UnshortenmeMakeError::call($ctx, null));
    }
    ...
    public function test_make_error_records_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->throw_err = false;
        $ctx->ctrl->explain = ['on' => true];
        UnshortenmeMakeError::call($ctx, null);
    ...
    public function test_feature_add_appends_in_call_order(): void
    {
        ...
        $a = new UnshortenmeBaseFeature();
        $b = new UnshortenmeBaseFeature();
        UnshortenmeFeatureAdd::call($ctx, $a);
        UnshortenmeFeatureAdd::call($ctx, $b);
        $this->assertSame([$a, $b], $client->features);
    }

    private static function named_feature(string $name): UnshortenmeBaseFeature
    {
        $f = new UnshortenmeBaseFeature();
        $f->name = $name;
        return $f;
    }
    ...
    public function test_feature_add_ordering_before_after_replace(): void
    {
        ...
        UnshortenmeFeatureAdd::call($ctx, $miss);
    ...
    private static function auth_ctx(array $options, ?array $headers): UnshortenmeContext
    {
        $client = new PlClient($options);
        return self::ctx([
            'client' => $client,
            'spec' => $headers === null ? null : new UnshortenmeSpec(['headers' => $headers]),
        ]);
    }
    ...
    public function test_prepare_auth_guards_a_missing_spec(): void
    {
        ...
        [, $err] = UnshortenmePrepareAuth::call($ctx);
    ...
    public function test_prepare_auth_a_raw_apikey_goes_in_as_is(): void
    {
        ...
        UnshortenmePrepareAuth::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'response' => new UnshortenmeResponse(['headers' => null]),
            'result' => new UnshortenmeResult([]),
        ]);
        UnshortenmeResultHeaders::call($ctx);
    ...
    public function test_result_body_skips_parsing_when_the_body_is_absent(): void
    {
        ...
        UnshortenmeResultBody::call($ctx);
