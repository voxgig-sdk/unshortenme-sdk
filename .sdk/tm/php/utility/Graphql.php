...
// Unshortenme SDK utility: graphql
//
...
class UnshortenmeGraphql
{
    ...
    // equivalent.
    public static function body(UnshortenmeContext $ctx): mixed
    {
    ...
    public static function errors(UnshortenmeContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
