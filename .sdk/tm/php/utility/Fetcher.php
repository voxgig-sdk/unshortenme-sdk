...
// Unshortenme SDK utility: fetcher

class UnshortenmeFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; UnshortenmeSDK/1.0)';
    ...
    public static function call(UnshortenmeContext $ctx, string $fullurl, array $fetchdef): array
    {
