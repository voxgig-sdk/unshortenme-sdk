...
class UnshortenmeRbacFeature extends UnshortenmeBaseFeature
{
    ...
    private function _required(UnshortenmeContext $ctx): ?string
    {
    ...
    private function _reject(UnshortenmeContext $ctx, string $required): void
    {
    ...
    private function _track(UnshortenmeContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
