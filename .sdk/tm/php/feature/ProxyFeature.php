...
class UnshortenmeProxyFeature extends UnshortenmeBaseFeature
{
    ...
    public function init(UnshortenmeContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (UnshortenmeContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
