...
// Unshortenme SDK idempotency feature
...
class UnshortenmeIdempotencyFeature extends UnshortenmeBaseFeature
{
    ...
    private function _mutating(UnshortenmeContext $ctx): bool
    {
