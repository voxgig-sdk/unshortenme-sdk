...
// Unshortenme SDK ratelimit feature
...
class UnshortenmeRatelimitFeature extends UnshortenmeBaseFeature
{
    ...
    private function _acquire(UnshortenmeContext $ctx): void
    {
    ...
    private function _track(UnshortenmeContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
