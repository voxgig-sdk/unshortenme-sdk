...
// Unshortenme SDK clienttrack feature
...
class UnshortenmeClienttrackFeature extends UnshortenmeBaseFeature
{
    ...
    public function PostConstruct(UnshortenmeContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'Unshortenme-SDK';
