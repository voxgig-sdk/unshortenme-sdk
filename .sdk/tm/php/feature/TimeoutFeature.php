...
// Unshortenme SDK timeout feature
...
class UnshortenmeTimeoutFeature extends UnshortenmeBaseFeature
{
    ...
    private function _with_timeout(UnshortenmeContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(UnshortenmeContext $_ctx, float $ms): void
    {
        $client = $this->client;
