...
class UnshortenmeTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = UnshortenmeTestRunner.getenv("PROJECTENV_TEST_LIVE")
        override = UnshortenmeTestRunner.getenv("PROJECTENV_TEST_OVERRIDE")
        ...
        explain = UnshortenmeTestRunner.getenv("PROJECTENV_TEST_EXPLAIN")
