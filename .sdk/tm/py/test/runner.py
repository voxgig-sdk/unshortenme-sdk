...
class UnshortenmeTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = UnshortenmeTestRunner.getenv("PROJECTNAME_TEST_LIVE")
        override = UnshortenmeTestRunner.getenv("PROJECTNAME_TEST_OVERRIDE")
        ...
        explain = UnshortenmeTestRunner.getenv("PROJECTNAME_TEST_EXPLAIN")
