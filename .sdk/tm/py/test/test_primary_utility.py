...
from projectname_sdk import UnshortenmeSDK
from projectname_sdk.core.spec import UnshortenmeSpec
from projectname_sdk.core.result import UnshortenmeResult
from projectname_sdk.core.response import UnshortenmeResponse
from projectname_sdk.core.operation import UnshortenmeOperation
from projectname_sdk.core.error import UnshortenmeError
from projectname_sdk.core import helpers
from projectname_sdk.feature.base_feature import UnshortenmeBaseFeature
...
def _err_from_map(m):
    ...
    if msg == "":
        return None
    code = m.get("code", "")
    return UnshortenmeError(code, msg)
...
class TestPrimaryUtility:
    ...
    def test_feature_init_basic(self):
        init_client = UnshortenmeSDK.test(None, None)
        ...
        class TestInitFeature(UnshortenmeBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "initfeat"
                self.active = True
    ...
    def test_feature_init_inactive(self):
        ...
        class TestInitFeatureInactive(UnshortenmeBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "nofeat"
                self.active = False
    ...
    def test_make_result_no_result(self):
        ...
        utility = client._utility
        ctx = _make_test_full_ctx(client, utility)
        ctx.spec = UnshortenmeSpec({"step": "start"})
        ctx.result = None
    ...
    def test_make_spec_basic(self):
        ...
        spec_client = UnshortenmeSDK.test(None, setup_opts)
    ...
    def test_operator_basic(self):
        ...
        def subject(entry):
            ...
            if not isinstance(in_val, dict):
                in_val = {}
            op = UnshortenmeOperation(in_val)
            return {
                "entity": op.entity,
                "name": op.name,
                "input": op.input,
    ...
    def test_prepare_auth_basic(self):
        ...
        auth_client = UnshortenmeSDK.test(None, setup_opts)
