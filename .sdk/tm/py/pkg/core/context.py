...
from projectname_sdk.core.control import UnshortenmeControl
...
class UnshortenmeContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        if isinstance(sp, UnshortenmeSpec):
            self.spec = sp
        elif basectx is not None:
        ...
        if isinstance(r, UnshortenmeResult):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, UnshortenmeResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def make_error(self, code, msg):
        return UnshortenmeError(code, msg, self)
