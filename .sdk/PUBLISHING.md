...
|---|---|---|
| `ts/` | @voxgig-sdk/unshortenme-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/unshortenme-sdk \
      --repository voxgig-sdk/unshortenme-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/unshortenme-sdk` shows it, and
`npm trust revoke @voxgig-sdk/unshortenme-sdk --id=<id>` removes it.
