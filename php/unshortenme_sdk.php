...
class UnshortenmeSDK
{
    ...
    public function __construct(array $options = [])
    {
        ...
        $feature_opts = UnshortenmeHelpers::to_map(Struct::getprop($this->options, "feature"));
        if ($feature_opts) {
            $featureorder = Struct::getpath($this->options, "__derived__.featureorder");
            if (is_array($featureorder)) {
                foreach ($featureorder as $fname) {
                    $fopts = UnshortenmeHelpers::to_map($feature_opts[$fname] ?? null);
                    if ($fopts && isset($fopts["active"]) && $fopts["active"] === true) {
                        ...
                        if (!UnshortenmeFeatures::has_feature($fname)) {
                        ...
                        ($utility->feature_add)($this->_rootctx, UnshortenmeFeatures::make_feature($fname));
                    }
                }
            }
        }
    ...
    {
        return UnshortenmeUtility::copy($this->_utility);
    }
    ...
    public function prepare(array $fetchargs = []): mixed
    {
        ...
        $ctrl = UnshortenmeHelpers::to_map(Struct::getprop($fetchargs, "ctrl")) ?? [];
        ...
        $params = UnshortenmeHelpers::to_map(Struct::getprop($fetchargs, "params")) ?? [];
        $query = UnshortenmeHelpers::to_map(Struct::getprop($fetchargs, "query")) ?? [];
    ...
    private function op_denied(string $op): array
    {
        ...
        return [
            "ok" => false,
            "err" => new UnshortenmeError($op . "_allow",
                "UnshortenmeSDK: " . $op . ": operation not allowed by" .
    ...
    private function raw_request(array $fetchargs = []): mixed
    {
        ...
        if (is_array($fetched)) {
            $status = UnshortenmeHelpers::to_int(Struct::getprop($fetched, "status"));
    ...
    public function graphql(string $query, ?array $variables = null, ?array $ctrl = null): mixed
    {
        ...
        if (is_array($errors) && 0 < count($errors)) {
            ...
            $res["ok"] = false;
            $res["err"] = new UnshortenmeError("graphql_error",
                "UnshortenmeSDK: graphql: " . $msg);
            $res["graphql"] = $errors;
        }
    ...
    public function Unshorten($data = null)
    {
        ...
        if ($data === null) {
            if ($this->_unshorten === null) {
                $this->_unshorten = new UnshortenEntity($this, null);
            }
            return $this->_unshorten;
        }
        return new UnshortenEntity($this, $data);
    }
    ...
    public static function test(?array $testopts = null, ?array $sdkopts = null): self
    {
        ...
        $sdk = new UnshortenmeSDK($sdkopts);
        $sdk->mode = "test";
        return $sdk;
    }
}
