...
// Unshortenme SDK netsim feature
...
class UnshortenmeNetsimFeature extends UnshortenmeBaseFeature
{
    ...
    private function _simulate(UnshortenmeContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(UnshortenmeContext $ctx, array $applied): void
    {
        $client = $this->client;
