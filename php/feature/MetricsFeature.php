...
// Unshortenme SDK metrics feature
...
class UnshortenmeMetricsFeature extends UnshortenmeBaseFeature
{
    ...
    private function _record(UnshortenmeContext $ctx, bool $ok): void
    {
