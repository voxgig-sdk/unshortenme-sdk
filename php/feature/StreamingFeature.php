...
// Unshortenme SDK streaming feature
...
class UnshortenmeStreamingFeature extends UnshortenmeBaseFeature
{
    ...
    private function _iterate(UnshortenmeResult $result): \Generator
    {
    ...
    private function _streamable(UnshortenmeContext $ctx): bool
    {
