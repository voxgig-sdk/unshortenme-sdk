...
// Unshortenme SDK telemetry feature
...
class UnshortenmeTelemetryFeature extends UnshortenmeBaseFeature
{
    ...
    private function _close(UnshortenmeContext $ctx, bool $ok): void
    {
