...
class UnshortenmeCacheFeature extends UnshortenmeBaseFeature
{
    ...
    private function _through(UnshortenmeContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
