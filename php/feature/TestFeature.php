...
// Unshortenme SDK test feature

require_once __DIR__ . '/BaseFeature.php';
require_once __DIR__ . '/../utility/Param.php';

class UnshortenmeTestFeature extends UnshortenmeBaseFeature
{
    ...
    public function init(UnshortenmeContext $ctx, array $options): void
    {
        ...
        $test_fetcher = function (UnshortenmeContext $fctx, string $_fullurl, array $_fetchdef) use ($entity): array {
            ...
            if ($op->name === 'load') {
                ...
                $id = UnshortenmeParam::call($fctx, 'id');
    ...
    public function makeNetsim(array $net, callable $inner): callable
    {
        ...
        return function (UnshortenmeContext $fctx, string $url, array $fetchdef) use ($net, $inner, $pick_latency, $sleep): array {
            $this->_netcalls++;
            $call = $this->_netcalls;
     ...
     */
    public function buildArgs(UnshortenmeContext $ctx, $op, $args): array
    {
