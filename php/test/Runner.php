...
class UnshortenmeTestRunner
{
    ...
    {
        $live = self::getenv('UNSHORTENME_TEST_LIVE');
        $override = self::getenv('UNSHORTENME_TEST_OVERRIDE');
        ...
        $explain = self::getenv('UNSHORTENME_TEST_EXPLAIN');
...
class_alias('UnshortenmeTestRunner', 'Runner');
class_alias('UnshortenmeHelpers', 'Helpers');
