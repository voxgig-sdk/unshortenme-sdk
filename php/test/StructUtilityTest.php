...
// Unshortenme SDK struct utility test
//
...
class StructUtilityTest extends TestCase
{
    ...
    {
        if (self::$run === null) {
            $runner = UnshortenmeOmni::makeStructRunner(
        ...
        $this->runsection(
            ...
            function ($input) {
                ...
                if (is_object($store) && $haspath && Struct::undef() !== $val) {
                    ...
                    if (json_encode(UnshortenmeOmni::structfix($now, Struct::undef()))
                        !== json_encode(UnshortenmeOmni::structfix($val, Struct::undef()))) {
