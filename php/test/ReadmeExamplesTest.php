...
// Unshortenme SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (UnshortenmeSDK::test)
...
{
    private const SDK_CLASS = 'UnshortenmeSDK';
    ...
    private const SDK_BASE = 'unshortenme_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../unshortenme_sdk.php';
        foreach ($this->phpBlocks() as $blk) {
