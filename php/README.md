...
The PHP SDK for the Unshortenme API — an entity-oriented client using PHP conventions.
...
```php
require_once 'unshortenme_sdk.php';
$client = new UnshortenmeSDK($options);
```
...
```
php/
├── unshortenme_sdk.php          -- Main SDK class
...
The main class (`unshortenme_sdk.php`) exports the SDK class
