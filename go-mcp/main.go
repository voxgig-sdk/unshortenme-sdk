// Command Unshortenme-mcp is an MCP server exposing the Unshortenme
// SDK as MCP tools.
//
// Two tools are registered:
//
//	Unshortenme_list  — list records of an entity
//	Unshortenme_load  — load a single record of an entity
//
