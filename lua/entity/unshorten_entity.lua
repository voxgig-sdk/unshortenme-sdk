...
local UnshortenEntity = {}
UnshortenEntity.__index = UnshortenEntity


function UnshortenEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, UnshortenEntity)
  self._name = "unshorten"
  self._client = client
...
function UnshortenEntity:get_name()
  return self._name
end


function UnshortenEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return UnshortenEntity.new(self._client, opts)
end
...
function UnshortenEntity:mark_deleted()
  self._deleted = true
end


function UnshortenEntity:deleted()
  return true == self._deleted
end


function UnshortenEntity:data_set(args)
  if args ~= nil then
...
function UnshortenEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function UnshortenEntity:match_set(args)
  if args ~= nil then
...
function UnshortenEntity:match_get()
...
function UnshortenEntity:stream(action, args, callopts)
...
---@param reqmatch UnshortenLoadMatch
---@param ctrl? table
---@return Unshorten
---@return string? err
function UnshortenEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
function UnshortenEntity:_run_op(ctx, post_done)
  local utility = self._utility
