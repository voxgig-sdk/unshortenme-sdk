...
function runner.env_override(m)
  local live = runner.getenv("UNSHORTENME_TEST_LIVE")
  local override = runner.getenv("UNSHORTENME_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("UNSHORTENME_TEST_EXPLAIN")
