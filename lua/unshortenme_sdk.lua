...
local UnshortenmeSDK = {}
UnshortenmeSDK.__index = UnshortenmeSDK
...
UnshortenmeSDK._make_feature = _make_feature


function UnshortenmeSDK.new(options)
  local self = setmetatable({}, UnshortenmeSDK)
  self.mode = "live"
  self.features = {}
  self.options = nil
...
function UnshortenmeSDK:options_map()
...
function UnshortenmeSDK:get_utility()
  return Utility.copy(self._utility)
end


function UnshortenmeSDK:get_root_ctx()
  return self._rootctx
end


function UnshortenmeSDK:prepare(fetchargs)
...
function UnshortenmeSDK:direct(fetchargs)
...
-- by passing it.
function UnshortenmeSDK:_raw_request(fetchargs)
  local utility = self._utility
...
function UnshortenmeSDK:graphql(query, variables, ctrl)
  ...
  if type(errors) == "table" and 0 < #errors then
    ...
    res.ok = false
    res.err = "UnshortenmeSDK: graphql: " .. msg
    res.graphql = errors
  end
...
function UnshortenmeSDK.test(testopts, sdkopts)
  sdkopts = sdkopts or {}
  ...
  local sdk = UnshortenmeSDK.new(sdkopts)
  sdk.mode = "test"
