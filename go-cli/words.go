...
func registerSDKWords(r *eng.Registry, client *sdk.UnshortenmeSDK) {
...
func runOp(client *sdk.UnshortenmeSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
