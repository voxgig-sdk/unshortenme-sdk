...
AQL-driven CLI and REPL for the Unshortenme SDK. Positional arguments are
...
./unshortenme-cli list unshorten
./unshortenme-cli load 1 unshorten
./unshortenme-cli load '{id:1}' unshorten
