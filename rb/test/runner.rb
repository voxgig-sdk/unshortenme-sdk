...
module UnshortenmeTestRunner
  ...
  def self.env_override(m)
    live = getenv("UNSHORTENME_TEST_LIVE")
    override = getenv("UNSHORTENME_TEST_OVERRIDE")
    ...
    explain = getenv("UNSHORTENME_TEST_EXPLAIN")
    m["UNSHORTENME_TEST_EXPLAIN"] = explain if explain && !explain.empty?
...
Runner = UnshortenmeTestRunner
Helpers = UnshortenmeHelpers
Vs = VoxgigStruct
