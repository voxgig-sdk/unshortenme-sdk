...
#      offline in seeded test mode (UnshortenmeSDK.test) against the real
...
class ReadmeExamplesTest < Minitest::Test
  ...
  SDK = File.join(__dir__, "..", "Unshortenme_sdk.rb")
  SDK_CLASS = "UnshortenmeSDK"
