...
Provides an easy method to unshorten a wide range of shortened URLs with rate limit and authorization header.

Learn more about Unshorten.me API at [unshorten.me/api](https://unshorten.me/api).
...
| --- | --- | --- |
| **Unshorten** | The Unshorten entity (load). | `/unshorten` |
