...
This is an unofficial SDK for the Unshorten.me public API, generated by Voxgig with [`@voxgig/sdkgen`](https://github.com/voxgig/sdkgen). It is not affiliated with, endorsed by, or sponsored by the upstream API provider.
...
| --- | --- | --- |
| TypeScript | `@voxgig-sdk/unshortenme` | `npm install @voxgig-sdk/unshortenme` |
| Python | `voxgig-sdk-unshortenme` | `pip install voxgig-sdk-unshortenme` |
| PHP | `voxgig-sdk/unshortenme` | `composer require voxgig-sdk/unshortenme` |
| Golang | `github.com/voxgig-sdk/unshortenme-sdk/go` | `go get github.com/voxgig-sdk/unshortenme-sdk/go` |
| Ruby | `voxgig-sdk-unshortenme` | `gem install voxgig-sdk-unshortenme` |
| Lua | `voxgig-sdk-unshortenme` | `luarocks install voxgig-sdk-unshortenme` |
