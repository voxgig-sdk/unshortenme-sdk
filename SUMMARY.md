...
Results: Successfully unshortened the URL.
...
| --- | --- | --- | --- |
| Unshorten | `load` | `GET /unshorten` | Required |

## Connect to the API

- Production server: `https://unshorten.me/api/v2`

The default credential is sent in the `Authorization` header.

Token-based authentication. Use the format: &#39;Token &#123;your_token&#125;&#39; where the token can be found in your profile page.
...
- `unshortenme_list`: List records for an entity. No active entity supports this operation.
- `unshortenme_load`: Load one record for an entity. Supported entities: `unshorten`.
